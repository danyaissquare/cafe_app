...
class AppTheme {
  ...
  static ButtonStyle stadiumElevatedButton =
  ...
  static ThemeData get pinkLightTheme =>
      _lightTheme(const Color.fromARGB(255, 155, 37, 76), Colors.pink.shade300);
  ...
  static ThemeData get redLightTheme =>
      _lightTheme(const Color.fromARGB(255, 161, 54, 52), Colors.red.shade400);
  ...
  static ThemeData get deepOrangeDarkTheme =>
      _darkTheme(const Color.fromARGB(255, 216, 68, 23));
  ...
  static ThemeData get purpleDarkTheme =>
      _darkTheme(const Color.fromARGB(255, 160, 48, 180));

  static ThemeData get redDarkTheme =>
      _darkTheme(const Color.fromARGB(255, 202, 62, 62));
